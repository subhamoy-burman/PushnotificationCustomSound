...
namespace NotificationHubSample.Droid
{
    ...
    public class FirebaseService : FirebaseMessagingService
    {
        ...
        void SendLocalNotification(string body)
        {
            ...
            Android.Net.Uri soundUri = Android.Net.Uri.FromFile(new Java.IO.File("//android_asset/ubesafe_sound.mp3"));

            Android.Net.Uri alarmSound = Android.Net.Uri.Parse("android.resource://" + PackageName + "/" + Resource.Raw.ubesafe_sound);
